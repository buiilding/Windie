...
export const DESKTOP_AGENT_SEND_CHANNELS = {
  PENDING_TURN: SEND_CHANNELS.WINDIE_PENDING_TURN,
} as const;
...
export const DESKTOP_AGENT_ON_CHANNELS = {
  ROWS: ON_CHANNELS.WINDIE_ROWS,
  STATUS: ON_CHANNELS.WINDIE_STATUS,
  CONVERSATION_EVENT: ON_CHANNELS.WINDIE_CONVERSATION_EVENT,
  MEMORY_STORE_CHANGED: ON_CHANNELS.WINDIE_MEMORY_STORE_CHANGED,
  CONVERSATION_METADATA_INVALIDATED: ON_CHANNELS.WINDIE_CONVERSATION_METADATA_INVALIDATED,
  CURRENT_TURN: ON_CHANNELS.WINDIE_CURRENT_TURN,
  PENDING_TURN: ON_CHANNELS.WINDIE_PENDING_TURN,
} as const;
