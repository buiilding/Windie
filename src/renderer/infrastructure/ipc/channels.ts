...
const EXPECTED_SHARED_CHANNEL_REGISTRY = {
  ...
  ON_CHANNELS: {
    ...
    DESKTOP_AGENT_STATUS: 'windie:status',
    ...
    DESKTOP_AGENT_CURRENT_TURN: 'windie:current-turn',
    DESKTOP_AGENT_PENDING_TURN: 'windie:pending-turn',
    TRANSCRIPT_SESSION_SYNC: 'transcript-session-sync',
...
export const DESKTOP_AGENT_SEND_CHANNELS = {
  PENDING_TURN: SEND_CHANNELS.DESKTOP_AGENT_PENDING_TURN,
} as const;
...
export const DESKTOP_AGENT_ON_CHANNELS = {
  ROWS: ON_CHANNELS.DESKTOP_AGENT_ROWS,
  STATUS: ON_CHANNELS.DESKTOP_AGENT_STATUS,
  CONVERSATION_EVENT: ON_CHANNELS.DESKTOP_AGENT_CONVERSATION_EVENT,
  MEMORY_STORE_CHANGED: ON_CHANNELS.DESKTOP_AGENT_MEMORY_STORE_CHANGED,
  CONVERSATION_METADATA_INVALIDATED: ON_CHANNELS.DESKTOP_AGENT_CONVERSATION_METADATA_INVALIDATED,
  CURRENT_TURN: ON_CHANNELS.DESKTOP_AGENT_CURRENT_TURN,
  PENDING_TURN: ON_CHANNELS.DESKTOP_AGENT_PENDING_TURN,
} as const;
