...
function syncSdkLiveTurnSurfaceIntent(currentTurn) {
  ...
  return handleSdkLiveTurnSurfaceIntent(currentTurn, {
    ...
    setResponseOverlayLayoutMode: surfaceRuntime.setResponseOverlayLayoutMode,
    ...
    isResponseOverlayGuardDismissed: surfaceRuntime.isResponseOverlayGuardDismissed,
...
const {
  ...
  appIconFileName: mainHostSkin.assets.appIconFileName,
  rendererLogPrefix: mainHostSkin.identity.logPrefix,
...
function initializeMainProcessIpc() {
  surfaceRuntime.initializeMainProcessIpcOnce(() => {
    initializeOverlayPhaseHandlersRuntime({
      ...
      getActiveResponseOverlayGuardRef: surfaceRuntime.getActiveResponseOverlayGuardRef,
      setActiveResponseOverlayGuardRef: surfaceRuntime.setActiveResponseOverlayGuardRef,
      getResponseOverlayLayoutMode: surfaceRuntime.getResponseOverlayLayoutMode,
      setResponseOverlayLayoutMode: surfaceRuntime.setResponseOverlayLayoutMode,
      clearResponseOverlayLayoutMode: surfaceRuntime.clearResponseOverlayLayoutMode,
