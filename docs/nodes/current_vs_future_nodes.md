---
summary: "Current versus future WindieOS node boundaries, separating implemented desktop/backend/local-runtime implementation/private automation worker nodes from planned mobile, edge, and multi-agent VM node work."
read_when:
...
| --- | --- | --- |
| One-agent-per-private automation runtime node | planned | WindieOS VM Multi-Agent Plan (private backend docs) |
| Remote VM control/viewer node | planned | WindieOS VM Multi-Agent Plan (private backend docs) |
| Multi-agent coordination node | planned | WindieOS Agent-to-Agent Communication Plan (private backend docs) |
